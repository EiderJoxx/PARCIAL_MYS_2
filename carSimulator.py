...
SOFT_BLUE = (173, 216, 230)  # Fondo suave
DARK_BLUE = (70, 130, 180)   # Azul más oscuro para botones
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
GREEN = (0, 204, 0)          # Verde brillante
RED = (255, 0, 0)
DARK_GRAY = (50, 50, 50)
...
class Mobile:
    ...
    def draw(self, screen):
        ...
        pygame.draw.rect(screen, DARK_GRAY, back)    # Parte trasera del carrito
...
def main():
    ...
    while running:
        ...
        screen.fill(SOFT_BLUE)  # Cambiar fondo
        ...
        pygame.draw.rect(screen, RED, brake_button)  # Botón de freno
        brake_text = font.render("Frenar", True, WHITE)  # Texto blanco
